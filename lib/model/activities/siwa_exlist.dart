...
class SiwaActivitiesExlist extends StatelessWidget {
  @override
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.siwaActivModel[index]
                                            .name}',
                                        style: TextStyle(
                                    ...
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '${controller.siwaActivModel[index].price1}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16.0,
                                        ),
