...
class HurghadaActivitiesExlist extends StatelessWidget {
  @override
      ...
      builder: (controller) =>
          Scaffold(
            appBar: AppBar(
              ...
              title: Text("Hurghada Activities"),
              centerTitle: true,
            ),
            body: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.hurghadaActivModel[index]
                                            .name}',
                                        style: TextStyle(
                                    ...
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '${controller.hurghadaActivModel[index].price1}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16.0,
                                        ),
