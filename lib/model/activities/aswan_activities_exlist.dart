...
class AswanActivitiesExlist extends StatelessWidget {
  @override
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.aswanActivModel[index]
                                            .name}',
                                        style: TextStyle(
                                    ...
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '${controller.aswanActivModel[index].price1}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16.0,
                                        ),
