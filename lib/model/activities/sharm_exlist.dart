...
class SharmActivitiesExlist extends StatelessWidget {
  @override
      ...
      builder: (controller) =>
          Scaffold(
            appBar: AppBar(
              ...
              title: Text("Sharm El-Sheikh Activities"),
              centerTitle: true,
            ),
            body: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.sharmActivModel[index]
                                            .name}',
                                        style: TextStyle(
                                    ...
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '${controller.sharmActivModel[index].price1}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16.0,
                                        ),
