...
class MarsaAlamActivitiesExlist extends StatelessWidget {
  @override
      ...
      builder: (controller) =>
          Scaffold(
            appBar: AppBar(
              ...
              title: Text("Marsa Alaam Activities"),
              centerTitle: true,
            ),
            body: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.marsaAlamActivModel[index]
                                            .name}',
                                        style: TextStyle(
                                    ...
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '${controller.marsaAlamActivModel[index].price1}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16.0,
                                        ),
