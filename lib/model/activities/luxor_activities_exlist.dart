...
class LuxorActivitiesExlist extends StatelessWidget {
  @override
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.luxoorActivModel[index]
                                            .name}',
                                        style: TextStyle(
                                    ...
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '${controller.luxoorActivModel[index].price1}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16.0,
                                        ),
