...
class LuxorHotelsExList extends StatelessWidget {
  @override
          ...
          Scaffold(
            ...
            body: Padding(
              ...
              child: ListView.builder(
                ...
                shrinkWrap: true,
                itemCount: controller.luxorHotelsModel.length,
                                ...
                                child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: Text(
                                        '${controller.luxorHotelsModel[index]
                                            .name}',
                                        style: TextStyle(
